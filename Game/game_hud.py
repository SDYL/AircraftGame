...
class HUDPanel(object):
    ...
    reward_score = 10000                # 奖励分值
    level2_score = 2000                 # 级别 2 分值
    level3_score = 20000                # 级别 3 分值

    record_filename = "record.text"     # 最好成绩文件名
    ...
    def __init__(self, display_group):
        ...
        # 6>提示标签
        self.tip_label = Label("Press spaceber to play again.", 22, self.white)      # display_group
